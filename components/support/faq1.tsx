  ...
  return (
    <div className="ml-3">
      ...
      <ul>
        ...
        <li>
          You’ll receive another email & SMS/ WhatsApp once your order is
          shipped out. All you have to do then is, sit back, relax, and wait for
          your awesome product(s) to arrive!
        </li>
      </ul>
      <p className="mt-2 mb-1">
      ...
      <ul>
        <li>
          ...
          Details’ section. We are continually expanding our capabilities to
          deliver across all the pincodes in the country.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          Delivery time may vary depending upon the shipping address and other
          factors (public holidays, extreme weather conditions, etc.).
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          only be available before your order is shipped. If you are facing an
          issue, please email us at ordersupport@sheinindias.com and we will
          sort it for you.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          and ship your product. That said, we never say never! You can always
          cancel the order before it has been packed and can place a new order.
          Don't worry, there are no cancellation charges.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          the order, login with the same phone number/email you used while
          placing the order.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          banking orders will be processed within 7-15 banking days.
        </li>
        <li>
          Refunds for orders paid through SHEIN STYLE STORE wallet will be
          refunded within 24-72 Business hours of cancellation.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          a link. You can also track it from your account on the website by
          Selecting ‘Orders’ from the top right corner and then clicking on
          'Track Order' for the respective Order ID.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          15 days. Some cities in north east India & J&K etc may take 15 to 20
          days. You could enter your pin code at the product view page to know
      ...
      <ul>
        <li>
          ...
          order . So, if you have missed the delivery please do not worry, we
          will try to make an attempt again. We’ll also drop you a call, in case
          you miss the delivery to understand your delivery requirements.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          depending on the destination. Please note that international orders
          may be subject to customs duties and taxes imposed by the recipient's
          country. If you have any specific questions about international
          shipping or need assistance with placing an international order,
          please feel free to contact our customer service team for further
          assistance.
        </li>
      </ul>
      ...
      <p className="mt-2 mb-1">
        <strong>
          15 I got an email/ sms /what’s app saying product has been delivered
      ...
      <ul>
        <li>
          ...
          available. Please check if the delivery is made to them. In case it is
          not, please drop us a mail and we’ll investigate the issue with our
          logistics partner.
        </li>
      </ul>
      ...
      <p className="mt-2 mb-1">
        <strong>
          16 I want to place an order but I don’t want any price tag or invoice
      ...
      <ul>
        <li>
          ...
          the prices on the invoice. Please reach out to us as soon as your
          order is placed. If you want to add a note to the gift, please email
          the note to us at ordersupport@sheinindias.com and immediately call us
          on our number so that we can add it before the order is shipped.
          Please note that the character limit for the note is 250 characters.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          Debit Card, Credit Card, or Net Banking, or you can get the products
          delivered to an alternate address (where COD is available).
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          Minimum order value should be ₹299 (excluding GST).
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          Money to your The SHEIN STYLE STORE which will reflect within 48-72
          business hours of initiation.
        </li>
      </ul>
    </div>
  );
