...
const CartComponent = ({ cookie, type, getPaymentSummary }) => {
  ...
  return (
    <>
      <div
        className={`flex flex-col ${
          type == "main" ? "px-body" : ""
        }  w-full md:mb-10 mb-5 md:pt-0 sm:pt-10 pt-5 md:mt-8 mt-4  `}
      >
        <div className="flex flex-col sm:gap-10 gap-5  border-gray-300   w-full ">
          <div className=" md:w-[100%] w-[100%]">
            <div className="flex items-center gap-2 md:mb-8 mb-4">
              <h1 className="font-semibold md:text-2xl text-xl px-2 ">
                MY CART{" "}
              </h1>
            </div>
          ...
          {type == "main" ? (
            ...
            >
              <button className="bg-secondary text-white font-semibold sm:w-[40%] w-full text-center py-2 sm:text-base text-xs">
                Checkout
              </button>
            </div>
          ) : (
    ...
    {
      type== "main" ?   <div className=" md:my-20 my-10">
      <SimilarProducts
